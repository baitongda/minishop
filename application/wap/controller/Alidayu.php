...
class Alidayu extends Base {
    ...
    {   
        ...
        import('util.taobao.top.TopClient');
        import('util.taobao.top.ResultSet');
        import('util.taobao.top.RequestCheckUtil');
        import('util.taobao.top.TopLogger');
        import('util.taobao.top.request.AlibabaAliqinFcSmsNumSendRequest');
