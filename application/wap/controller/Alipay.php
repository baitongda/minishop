...
class Alipay extends Base
{
	...
	*/
	public function pay()
	{
		...
		/************************************************************/
		import('util.pay.Alipay.AlipayCore');
		import('util.pay.Alipay.AlipayMd5');
		import('util.pay.Alipay.AlipayNotify');
		import('util.pay.Alipay.AlipaySubmit');
		import('util.pay.Alipay.AlipayConfig');
