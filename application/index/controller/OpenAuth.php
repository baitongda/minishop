...
class OpenAuth extends Base
{
	...
	public function login($type = null){
        ...
        if ($type == 'wechat') {
            ...
            $wechatUrl = 'https://open.weixin.qq.com/connect/qrconnect?appid='.config('wx_app_id')
            ...
            import('util.thinksdk.ThinkOauth');
    ...
    public function wechat()
    {
        ...
        $url = 'https://api.weixin.qq.com/sns/oauth2/access_token?appid='.config('wx_app_id').'&secret='.config('wx_app_secret').'&code='.$response_type.'&grant_type=authorization_code';
