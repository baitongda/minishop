	...
	*/
	public function index()
	{
        ...
        foreach ($lists as $key1 => $value1) {
        	$lists[$key1]['selectGoods'] = '0';
        	if(is_array($selectGoods)){
	        	foreach ($selectGoods as $key2 => $value2) {
	        		if($value1['id'] == (int)$value2){
	        			$lists[$key1]['selectGoods'] = '1';
	        		}
	        	}
	        }else{
	        	if($value1['id'] == (int)$selectGoods){
	        			$lists[$key1]['selectGoods'] = '1';
	        		}
	        }
        }
